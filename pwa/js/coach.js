(function () {
  ...
  function advice() {
    ...
    if (strong.length) { out.push({title:'Strong in '+strong[0].category, body:'You are at '+strong[0].accuracy+'% on '+strong[0].category+'. To consolidate, try Hard-difficulty questions or increase your daily goal.'}); }
